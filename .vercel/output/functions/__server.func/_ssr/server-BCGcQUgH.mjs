...
import { r as csrfSymbol, t as createCsrfMiddleware } from "./createCsrfMiddleware-f-2zZAGW.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CHS_IA0y.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CRHL32Hh.mjs"),
		import("./start-zT9ptOve.mjs"),
